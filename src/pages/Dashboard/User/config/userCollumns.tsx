...
const userCollumns = ({
  ...
  const handleDeleteClick = (id: GridRowId) => async () => {
    props.setStatusButtons(true);
    await confirm({ description: `Deseja apagar este usuario ${id}`, title: 'Aviso' })
      .then(async () => {
        const newRows = props.rows?.filter(row => row.id !== id);
        const { response, error } = await useAxios({ method: 'delete', url: `user/${id}` });
        if (response) {
  ...
  return [
    ...
    },
    {
      ...
      renderCell: (params: GridRenderCellParams): JSX.Element => {
        return <TooltipCell params={params} collumns='surname' />;
      },
    },
    {
      field: 'email',
      ...
      renderCell: (params: GridRenderCellParams): JSX.Element => {
        return <TooltipCell params={params} collumns='email' />;
      },
    },
    {
      field: 'username',
      ...
      renderCell: (params: GridRenderCellParams): JSX.Element => {
        return <TooltipCell params={params} collumns='username' />;
      },
    },
    {
      field: 'password',
      ...
      renderCell: (params: GridRenderCellParams): JSX.Element => {
        return <TooltipCell params={params} collumns='password' />;
      },
    },
    {
      field: 'is_admin',
      ...
      flex: 1,
      editable: true,
      description: 'Informa se o usuario é administrador',
      renderCell: (params: GridRenderCellParams): JSX.Element => {
        return <TooltipCell params={params} collumns='is_admin' />;
      },
    },
    {
      field: 'role_id',
      ...
      renderCell: (params: GridRenderCellParams): JSX.Element => {
        return <TooltipCell params={params} collumns='role_id' />;
      },
    },
    {
      field: 'actions',
      ...
      sortable: false,
      flex: 1,
      description: 'Edite e exclua usuarios',
